...
create_data_model_with_translated_species_attribute<-
  function(path, # path to the excel document with the species "your_path/wildlife_species_list_template.xlsx"
           ...
           save_to){ #path where the data model with the species attibute should be constructed
...
writeLines(xml_text, con = paste0(save_to, "/", "species_smarter_attribute.xml"))
...
path<-"/wildlife_species_list_template.xlsx"
number_of_sheets<-4
